...
const AddRoom = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            // Converting amenities object to array of selected amenities
            const amenities = Object.keys(inputs.amentities).filter(key => inputs.amentities[key])
  ...
  return (
    <form onSubmit={onSubmitHandler}>
        <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the details carefully and accurate room details, pricing, and amentities, to enhance the userbooking Experience.'/>
        ...
        <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
            {Object.keys(inputs.amentities).map((amenity, index)=>(
                <div key={index}>
                    <input type="checkbox" id={`amenities${index+1}`} checked={inputs.amentities[amenity]} onChange={()=>setInputs({...inputs, amentities: {...inputs.amentities, [amenity]: !inputs.amentities [amenity]}})}/>
